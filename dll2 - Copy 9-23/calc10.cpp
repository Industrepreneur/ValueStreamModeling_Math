...
//float fvalue_ci  (int * ci, float *lot1);
//void dif1_ci     (int * ci, float * vector, float * diff);
//void frprmn   (int * ci, float *p, int n, float ftol, int * iter, float *fret, float (*func)(int * ci, float *lot1), void (*dfunc) (int * ci, float * vector2, float * diff)); 
...
//void frprmn   (float ftol, int * iter, float *fret,  int * ci, float (*func)(int * ci), void (*dfunc) (int * ci ));
                        ...
                        )            
{
        ...
        c1->valueOfParameterAffected = vector (1, c1->numberOfParameterAffected+5);
            ...
            c1->partPointer= (class_part**)malloc(sizeof(class_part)*c1->numberOfParameterAffected);
            c1->isLotOrTbatch=(int*)malloc(sizeof(int)*c1->numberOfParameterAffected);
            j=0;
            for (i=0; i<numberOfParts; i++)
            {
	 ...
	 frprmn  (c1,  c1->valueOfParameterAffected, c1->numberOfParameterAffected, &c1->resultValue);  
    	  ...
    	  frprmn  (c1,  c1->valueOfParameterAffected, c1->numberOfParameterAffected, &c1->resultValue);  
            ...
            free_vector (c1->valueOfParameterAffected, 1, c1->numberOfParameterAffected+5);
            free (c1->partPointer);
